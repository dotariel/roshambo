class Legacy {
  ...
  private static void makeSelection() {
    if (playersChoice == "r" || playersChoice == "p" || playersChoice == "s") {
      ...
      println("You chose ${playersChoice} and the computer chose ${computerPick}")
      ...
      println("Score is You = ${humanScore} and the Machine = ${compScore}")

      if (humanScore > compScore) {
        println("Keep beating the machine")
      }
      else if (compScore > humanScore) {
        println("You are getting your ass handed to you!!!")
      }
      else {
        println("Can someone go ahead already, geez")
      }
